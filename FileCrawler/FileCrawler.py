...
print("\nUse can use this program to scan drives and find specific file types. Simply add file extension types to the 'ShortExtensionList.txt' file in this program's folder.  \n")
...
sUserInput = input("\nEnter the drive you want to scan. For example, 'C:' without quotes: ")

sUserNamedLog = input("\nName your log, so you know what it's called. For example, 'MyLog.txt' without quotes. It will be located in the same folder as this program. You'll need this to reference the original file paths: ")
print("\n")
